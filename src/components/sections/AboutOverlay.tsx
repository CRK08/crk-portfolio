    ...
    <OverlayCard visible={visible} side="left" transition="0.5s" cardClass="village-card-warm">
      ...
      <div ref={scrollRef} style={{ overflow: "hidden", maxHeight: "calc(100vh - 19rem)" }}>
        <p className="body-text" style={{ fontSize: "0.82rem", marginBottom: "0.9rem" }}>
          I'm Kaviyarasan C, a final-year B.E. CSE student from Coimbatore, Tamil Nadu, focused on full-stack web and mobile development with AI integration.<br /><br />
          Smart Uzhavar is a live platform that gives small and marginal farmers real-time Mandi prices, AI-powered crop advisory via Gemini API, and community support — built with Next.js, PostgreSQL, and deployed on Vercel.<br /><br />
          Travid is an accessibility-first Flutter app for visually impaired users with voice biometric security, real-time navigation, and offline maps — published in IJSREM, November 2025.<br /><br />
